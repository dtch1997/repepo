...
from .helpers import add_vector_after_position, find_instruction_end_postion
...
# Modified so we can test with our own model instances without having to loa
# a massive 7b model from the internet in a testcase
class LlamaWrapper:
    def __init__(
        self,
        model: t.nn.Module,
