...
@dataclass
class EvaluateCaaInDistributionConfig:
...
def evaluate_caa_in_distribution(
    config: EvaluateCaaInDistributionConfig,
...
if __name__ == "__main__":
    config = pyrallis.parse(EvaluateCaaInDistributionConfig)
    results = evaluate_caa_in_distribution(config)
