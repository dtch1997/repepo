...
from repepo.steering.plot_results_by_layer_and_multiplier import (
    plot_results_by_layer_and_multiplier,
)
...
if __name__ == "__main__":
    ...
    run_sweep(configs, "caa_sycophancy")

    import matplotlib.pyplot as plt

    fig, ax = plt.subplots(1, 1, figsize=(8, 8))
    plot_results_by_layer_and_multiplier(ax, configs)
