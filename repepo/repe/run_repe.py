...
import numpy as np
import json
from repepo.repe.repe_dataset import bias_dataset, ambig_prompt_dataset
from repepo.repe.repe_dataset import SENTIMENT_TEMPLATE, ENTAILMENT_TEMPLATE, TOXICITY_TEMPLATE, BOOLQ_TEMPLATE, SENTIMENT_TEST_INPUTS, ENTAILMENT_TEST_INPUTS, TOXICITY_TEST_INPUTS, BOOLQ_TEST_INPUTS
...
sentiment_length_ds = ambig_prompt_dataset(path_to_dataset, max_ds_size=50, user_tag=default_user_tag, assistant_tag=assistant_tag)
...
sentiment_inputs = [SENTIMENT_TEMPLATE.format(user_tag=default_user_tag, statement=s, assistant_tag=assistant_tag) for s in SENTIMENT_TEST_INPUTS]
